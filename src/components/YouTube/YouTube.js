...
const weatherNowVideoDescription =
  "WeatherNow - Das aktuelle Wetter für JEDEN Ort der Welt prüfen!";
const gamesVideoDescription =
  "TicTacToe und ein FlappyBird-Klon zum Zeitvertreib für zwischendurch!";
  ...
  return (
    <div className={classes.YouTube} id="youtube">
      ...
      <div ref={ref} className={classes.YouTubeContent}>
        ...
        >
          {youtubeVideo(
            "https://youtu.be/i_yD-gn5iBg",
            QuizTopia,
            quiztopiaVideoDescription
          )}

          {youtubeVideo(
            "https://youtu.be/3MctlVzu3aI",
            WeatherNow,
            weatherNowVideoDescription
          )}

          {youtubeVideo(
            "https://youtu.be/i_yD-gn5iBg",
            JavaScriptGames,
            gamesVideoDescription
          )}
